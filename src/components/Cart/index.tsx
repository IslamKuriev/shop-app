...
import { cartElementDec, cartElementInc, cartRemoveElement,  } from "../../features/shopReducer";
...
const Cart = () => {
  ...
  return (
    <>
      ...
      <button className={styles.btnExit} onClick={handleExit}><img style={{width: "30px"}} src="../public/exit.svg" alt="" /></button>
      <div className={styles.cartMain}>
        ...
        <div className={styles.cartElements}>
            ...
            return products.map((product) => {
              if(product.id === c.productId) {
                ...
                <div className={styles.cartLeft}>
                    ...
                    <button style={{background: "none", border: "none"}} onClick={() => handleRemove(product.id)}><img style={{width: "20px"}} src="../public/delete.svg" alt="Удалить" /></button>
                </div>
                </div>
              )
              }
          ...
          }): <div style={{padding: "10px", fontSize: "18px"}}>Тут пусто. Добавьте товар в корзину</div>}
        </div>
      </div>
    </>
  );
